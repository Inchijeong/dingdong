...
<body>
    ...
    <div class="ui">
      <input type="hidden" class="ui-input" type="text" />
      <h3 id="skip">skip</h3>
    </div>
...
//              S.UI.simulate("Shape|Shifter|Type|to start|#rectangle|#countdown 3||");
              S.UI.simulate("Smart|Security|Interactive|DingDong|#countdown 3||");
            }
        ...
        var goHome = function(){
        	location.href="http://192.168.0.25:8070/device";
        }; 
        var $skip = $("#skip");
